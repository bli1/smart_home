function [Dynp, l_avg] = gen_Dtable_schedulable(runtime, price, power, R_state, B_state, B_opt, B_init, B_end, B_max, lamda)
        ...
        for r = 1: remain
            if Dynp(r, t, 1) == 1
                ...
                for b = 1:length_next_B_opt
                    ...
                    [Dynp(: , t+1, :), l_avg] = next_state(Dynp(:, t, :), ...
                        Dynp(:, t+1, :), runtime, price, power, next_opt, R, ...
                        r, b, t, timeslot, next_B_opt, B_state, lamda, B_init, B_end);
                end
            end
        end
    end
