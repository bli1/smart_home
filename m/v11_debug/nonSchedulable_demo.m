function [  ] = nonSchedulable_demo(  )
    ...
    save('pltA.mat', 'pltA');
    save('B_state_schedulable.mat', 'B_state_schedulable');
    save('R_state_schedulable.mat', 'R_state_schedulable');
    save('power_schedulable.mat', 'power_schedulable');
    save('price.mat', 'price');
    save('l_avg.mat', 'l_avg');
    save('lamda.mat', 'lamda');
    save('app.mat', 'app');
    save('best_price.mat', 'best_price');
    save('iter.mat', 'iter');
    save('full_power_t_wst_list.mat','full_power_t_wst_list');
    save('best_price_schedulable.mat','best_price_schedulable');
