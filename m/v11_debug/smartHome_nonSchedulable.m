function [best_price, iter, pltA, B_state_schedulable, ...
    R_state_schedulable, power_schedulable, l_avg, ...
    full_power_t_wst_list, best_price_schedulable, ...
    full_power_t] = smartHome_nonSchedulable(price, runtime_schedulable, ...
    power_schedulable, runtime_nonschedulable, ...
...
%B_state, Dtable
    ...
    for iter = 1: 10
        ...
        [solution_nonschedulable_wst, full_power_t, best_price, ...
            pltA] = gen_Dtable_worstCase(runtime_nonschedulable, ... 
        ...
        full_power_t_wst_list = full_power_t;
