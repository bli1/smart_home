function [best_price, iter, pltA, B_state_schedulable, R_state_schedulable, power_schedulable, l_avg, full_power_t_wst_list, best_price_schedulable] = smartHome(price, runtime_schedulable, power_schedulable, ...
